...
public class HomeActivity extends AppCompatActivity {
    ...
    public void translateText(final String message) {
//        TextView sourceTextView = (TextView) findViewById(R.id.txt_Email);
//
//        sourceText = sourceTextView.getText().toString();
        String getURL="";
        if(!message.isEmpty())
        getURL = "http://gateway-a.watsonplatform.net/calls/text/TextGetTextSentiment" +
                "?apikey=d0e7bf68cdda677938e6c186eaf2b755ef737cd8" +
                "&outputMode=json&text=" + message;//The API service URL
                ...
                client.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        try {
                            ...
                            final String sentiment = jsonResult.getJSONObject("docSentiment")
                                    .get("type").toString();
                            final String resultText = "You spoke : " + message +
                                    "\n From your words it seems you have a " +
                                    sentiment + " attitude";
