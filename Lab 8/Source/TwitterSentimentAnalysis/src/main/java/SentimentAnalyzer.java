...
//    }
    ...
    private String toCss(int sentiment) {
        switch (sentiment) {
            case 0:
                return "The sentiment of Tweet seems to be : very negative";
            case 1:
                return "The sentiment of Tweet seems to be : negative";
            case 2:
                return "The sentiment of Tweet seems to be : neutral";
            case 3:
                return "The sentiment of Tweet seems to be : positive";
            case 4:
                return "The sentiment of Tweet seems to be : very positive";
            default:
                return "";
        }
    }
