...
/**
  * Created by Raghu on 23-Mar-16.
  */
object StreamingTestData {

  def main(args: Array[String]) {

    val tags = List("music", "movie", "sport", "food", "uselections")
    ...
    while (true) {
      ...
      while (s.isConnected) {
        ...
        val imageString = sendGet(tags(randomCategoryID), randomCategoryID)
  ...
  private def sendGet(tag: String, tagId: Int): List[String] = {
    val url: String = "https://api.instagram.com/v1/tags/" + tag + "/media/recent?" +
      "access_token=2242837681.1677ed0.40e41f58cf2e456fa6859e67d701f9af&count=1"
