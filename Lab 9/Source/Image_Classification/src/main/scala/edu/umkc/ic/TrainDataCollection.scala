...
object TrainDataCollection {
  val PATH = "instadata3/"
  val PATHR = "instadata3/recommendation"
  ...
  def main(args: Array[String]) {
    ...
    // val tags = List("sushi")
    val tags = List("uselections","food")
  ...
  @throws(classOf[Exception])//3056470272.eb1a101.a984e679901a418d820892b550b03445
  private def sendGet(tag: String, tagId: Int) {
    val url: String = "https://api.instagram.com/v1/tags/" + tag + "/media/recent?" +
      "access_token=2242837681.1677ed0.40e41f58cf2e456fa6859e67d701f9af&count=100"
